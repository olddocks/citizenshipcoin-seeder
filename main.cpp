...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Citizenshipcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.citizenshipcoin.org",""};
static const string testnet_seeds[] = {"testnet-seed.citizenshipcoin.org", ""};
